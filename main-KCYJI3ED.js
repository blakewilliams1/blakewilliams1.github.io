...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-LYMDH6IZ.js").then((m) => m.HomePage)
  },
  {
    path: "career",
    loadComponent: () => import("./chunk-6UYMXRPM.js").then((m) => m.CareerPage)
  },
  {
    path: "projects",
  ...
  {
    path: "fursuit",
    loadComponent: () => import("./chunk-GWP4XSQF.js").then((m) => m.FursuitPage)
  },
  {
    path: "travels",
    loadComponent: () => import("./chunk-IVTEQ33C.js").then((m) => m.TravelsPage)
  },
  {
    path: "css-injection",
    loadComponent: () => import("./chunk-6NYOJQCZ.js").then((m) => m.CssInjectionPage)
  },
  {
    path: "burning-man-2023",
    loadComponent: () => import("./chunk-2BVY66FT.js").then((m) => m.BurningMan2023Page)
  },
  {
    path: "mauritania-trip",
    loadComponent: () => import("./chunk-F2DC5O2Y.js").then((m) => m.MauritaniaTripPage)
  },
  {
    path: "road-to-ushuaia",
    loadComponent: () => import("./chunk-ALQIQNRL.js").then((m) => m.RoadToUshuaiaPage)
  },
  {
    path: "shasta",
    loadComponent: () => import("./chunk-WWA5HP6Y.js").then((m) => m.ShastaTripPage)
  },
  {
    path: "half-dome",
    loadComponent: () => import("./chunk-MYFESOQM.js").then((m) => m.HalfDomeHikePage)
  },
  {
    path: "qr",
    loadComponent: () => import("./chunk-7MRL6L3I.js").then((m) => m.QRLandingPage)
  },
  {
    path: "qr/about",
    loadComponent: () => import("./chunk-II3FQ6H6.js").then((m) => m.AboutQrPage)
  },
  {
    path: "contact",
    loadComponent: () => import("./chunk-NBTBNCQV.js").then((m) => m.ContactFormPage)
  },
...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const moduleImpl = this.moduleImpl ?? import("./chunk-JEBXF6VJ.js");
...
var inMemoryScrollingFeatures = withInMemoryScrolling({
...
var AppComponent = class _AppComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 12, vars: 13, consts: [["tabPanel", ""], ["mat-tab-nav-bar", "", 3, "tabPanel"], ["mat-tab-link", "", "routerLink", "/", 3, "ngClass"], ["mat-tab-link", "", "routerLink", "/travels", 3, "ngClass"], ["mat-tab-link", "", "routerLink", "/projects", 3, "ngClass"], ["mat-tab-link", "", "routerLink", "/career", 3, "ngClass"]], template: function AppComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(8, "Career");
        \u0275\u0275elementEnd()();
        \u0275\u0275element(9, "router-outlet")(10, "mat-tab-nav-panel", null, 0);
      }
      if (rf & 2) {
        const tabPanel_r1 = \u0275\u0275reference(11);
        \u0275\u0275property("tabPanel", tabPanel_r1);
        \u0275\u0275advance();
        \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(5, _c03, ctx.currentRoute === "/"));
        \u0275\u0275advance(2);
        \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(7, _c03, ctx.currentRoute === "/travels"));
        \u0275\u0275advance(2);
        \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(9, _c03, ctx.currentRoute === "/projects"));
        \u0275\u0275advance(2);
        \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(11, _c03, ctx.currentRoute === "/career"));
      }
    }, dependencies: [CommonModule, NgClass, MatTabsModule, MatTabNav, MatTabNavPanel, MatTabLink, RouterModule, RouterOutlet, RouterLink], styles: ["\n\n[_nghost-%COMP%]   .bold-title[_ngcontent-%COMP%]     span {\n  font-weight: bold;\n  color: white;\n}"] });
  }
};
(() => {
