...
// src/app/contact/contact_form_page.ts
function ContactFormPage_mat_card_1_mat_error_11_Template(rf, ctx) {
  if (rf & 1) {
...
function ContactFormPage_mat_card_1_mat_error_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
    \u0275\u0275text(1, "Not a valid email address");
    \u0275\u0275elementEnd();
  }
}
function ContactFormPage_mat_card_1_mat_error_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
    \u0275\u0275text(1, "Subject title is required");
    \u0275\u0275elementEnd();
  }
}
function ContactFormPage_mat_card_1_mat_error_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
    \u0275\u0275text(1, "Message must not be empty");
    \u0275\u0275elementEnd();
  }
}
function ContactFormPage_mat_card_1_button_27_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("disabled", ctx_r1.contactForm.invalid);
  }
}
function ContactFormPage_mat_card_1_mat_spinner_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-spinner", 16);
  }
  if (rf & 2) {
    \u0275\u0275property("diameter", 36);
  }
}
function ContactFormPage_mat_card_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-card")(1, "h1", 2);
    \u0275\u0275text(2, "Contact Form");
    \u0275\u0275elementEnd();
    \u0275\u0275element(3, "div", 3);
    \u0275\u0275elementStart(4, "p");
    \u0275\u0275text(5, "This form will send an email directly to me. I'll respond to you asap!");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "form", 4);
    \u0275\u0275listener("ngSubmit", function ContactFormPage_mat_card_1_Template_form_ngSubmit_6_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onSubmit());
    });
    \u0275\u0275elementStart(7, "mat-form-field", 5)(8, "mat-label", 6);
    \u0275\u0275text(9, "Name");
    \u0275\u0275elementEnd();
    \u0275\u0275element(10, "input", 7);
    \u0275\u0275template(11, ContactFormPage_mat_card_1_mat_error_11_Template, 2, 0, "mat-error", 1);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "mat-form-field", 5)(13, "mat-label", 6);
    \u0275\u0275text(14, "Email");
    \u0275\u0275elementEnd();
    \u0275\u0275element(15, "input", 8);
    \u0275\u0275template(16, ContactFormPage_mat_card_1_mat_error_16_Template, 2, 0, "mat-error", 1);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "mat-form-field", 9)(18, "mat-label");
    \u0275\u0275text(19, "Subject");
    \u0275\u0275elementEnd();
    \u0275\u0275element(20, "input", 10);
    \u0275\u0275template(21, ContactFormPage_mat_card_1_mat_error_21_Template, 2, 0, "mat-error", 1);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "mat-form-field", 11)(23, "mat-label", 6);
    \u0275\u0275text(24, "Message");
    \u0275\u0275elementEnd();
    \u0275\u0275element(25, "textarea", 12);
    \u0275\u0275template(26, ContactFormPage_mat_card_1_mat_error_26_Template, 2, 0, "mat-error", 1);
    \u0275\u0275elementEnd();
    \u0275\u0275template(27, ContactFormPage_mat_card_1_button_27_Template, 2, 1, "button", 13);
    \u0275\u0275elementEnd();
    \u0275\u0275template(28, ContactFormPage_mat_card_1_mat_spinner_28_Template, 1, 1, "mat-spinner", 14);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(5);
    \u0275\u0275property("ngIf", ctx_r1.nameField.invalid);
    \u0275\u0275advance(5);
    \u0275\u0275property("ngIf", ctx_r1.emailField.invalid);
    \u0275\u0275advance(5);
    \u0275\u0275property("ngIf", ctx_r1.subjectField.invalid);
    \u0275\u0275advance(5);
    \u0275\u0275property("ngIf", ctx_r1.messageField.invalid);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r1.formIsSubmitting);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.formIsSubmitting);
  }
}
function ContactFormPage_mat_card_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-card")(1, "p");
    \u0275\u0275text(2, "Form submitted successfully! Thank you for reaching out to me :)");
    \u0275\u0275elementEnd()();
  }
}
var ContactFormPage = class _ContactFormPage {
  constructor() {
  ...
  static {
    this.\u0275fac = function ContactFormPage_Factory(t) {
      return new (t || _ContactFormPage)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ContactFormPage, selectors: [["contact-form-page"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 3, vars: 2, consts: [[1, "page-container"], [4, "ngIf"], [2, "text-align", "center"], [1, "divider"], [3, "ngSubmit", "formGroup"], ["required", "", "appearance", "outline", 1, "short-field"], [1, "form-label"], ["matInput", "", "formControlName", "name", "placeholder", "Your name", "type", "text", 1, "form-input"], ["matInput", "", "formControlName", "email", "placeholder", "Your email", "type", "email", 1, "form-input"], ["appearance", "outline", 1, "short-field"], ["matInput", "", "formControlName", "subject", "type", "text"], ["required", "", "appearance", "outline"], ["matInput", "", "formControlName", "message", "placeholder", "Your message"], ["mat-button", "", "type", "submit", 3, "disabled", 4, "ngIf"], [3, "diameter", 4, "ngIf"], ["mat-button", "", "type", "submit", 3, "disabled"], [3, "diameter"]], template: function ContactFormPage_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
        \u0275\u0275template(1, ContactFormPage_mat_card_1_Template, 29, 7, "mat-card", 1)(2, ContactFormPage_mat_card_2_Template, 3, 0, "mat-card", 1);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", !ctx.formSubmittedSuccessfully);
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", ctx.formSubmittedSuccessfully);
      }
    }, dependencies: [
      ...
      MatCardModule,
      MatCard
    ], styles: ["\n\n.divider[_ngcontent-%COMP%] {\n  border-top: 1px solid white;\n  margin-bottom: 1em;\n}\nmat-card[_ngcontent-%COMP%] {\n  margin: 20px 5%;\n  max-width: 800px;\n}\n.page-container[_ngcontent-%COMP%] {\n  margin: 0 auto;\n  width: fit-content;\n}\np[_ngcontent-%COMP%] {\n  margin-bottom: 2em;\n}\nmat-form-field[_ngcontent-%COMP%] {\n  display: block;\n  margin: 1em 0;\n}\n.short-field[_ngcontent-%COMP%] {\n  width: 66%;\n}\ntextarea[_ngcontent-%COMP%] {\n  min-height: 160px;\n}\ninput[_ngcontent-%COMP%]:-webkit-autofill {\n  -webkit-box-shadow: 0 0 0px 1000px #424242 inset !important;\n  -webkit-text-fill-color: white;\n}"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ContactFormPage, { className: "ContactFormPage", filePath: "src\\app\\contact\\contact_form_page.ts", lineNumber: 25 });
})();
export {
  ContactFormPage
};
