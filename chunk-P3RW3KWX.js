import{j as w,k as y,m as v}from"./chunk-H4LMR65P.js";import{Fa as f,Gb as r,Hb as h,Ja as o,Va as p,Za as d,kb as l,lb as a,mb as i,nb as s,sb as u}from"./chunk-I2TCTK3J.js";function k(t,n){t&1&&s(0,"div",8)}function T(t,n){if(t&1&&(a(0,"div",1)(1,"div",2)(2,"span"),r(3),i(),a(4,"div",3),s(5,"div",4),d(6,k,1,0,"div",5),i()(),a(7,"div",6)(8,"h2"),r(9),i(),s(10,"span",7),i()()),t&2){let e=n.$implicit,c=n.index,g=u();o(3),h(g.calculateTimelineDate(e.date)),o(3),l("ngIf",c!=g.timelineEvents.length-1),o(3),h(e.title),o(),l("innerHtml",e.content,f)}}var m=class t{timelineEvents=[];calculateTimelineDate(n){return new Intl.DateTimeFormat("en-US",{year:"numeric",month:"long"}).format(n)}static \u0275fac=function(e){return new(e||t)};static \u0275cmp=p({type:t,selectors:[["timeline"]],inputs:{timelineEvents:"timelineEvents"},decls:1,vars:1,consts:[["class","timeline-block",4,"ngFor","ngForOf"],[1,"timeline-block"],[1,"timeline-bar-container"],[1,"timeline-bar"],[1,"timeline-node"],["class","timeline-line",4,"ngIf"],[1,"timeline-content"],[3,"innerHtml"],[1,"timeline-line"]],template:function(e,c){e&1&&d(0,T,11,4,"div",0),e&2&&l("ngForOf",c.timelineEvents)},dependencies:[v,w,y],styles:[".timeline-block[_ngcontent-%COMP%], .timeline-bar-container[_ngcontent-%COMP%]{display:flex}.timeline-bar-container[_ngcontent-%COMP%]   span[_ngcontent-%COMP%]{min-width:80px;text-align:right;padding:6px 10px 0 0}.timeline-bar[_ngcontent-%COMP%]{display:inline-block}.timeline-node[_ngcontent-%COMP%]{border:3px solid grey}.timeline-line[_ngcontent-%COMP%]{border:2px solid grey;height:calc(100% - 33px);margin:auto;min-height:30px;width:0}.timeline-node[_ngcontent-%COMP%]{border-radius:18px;border-color:gray;height:25px;width:25px}.timeline-content[_ngcontent-%COMP%]{padding:0 20px 20px;flex-grow:1}.timeline-content[_ngcontent-%COMP%]   span[_ngcontent-%COMP%]{color:#d3d3d3}h2[_ngcontent-%COMP%]{margin-top:0}"]})};var b=class t{projectTimeline=[{date:new Date(16781652e5),title:"Senior Engineer",content:`<p>Still at Google, I was promoted to L5 for my contributions to the AV/VR efforts
        ...
        industry after schooling.`}];static \u0275fac=function(e){return new(e||t)};static \u0275cmp=p({type:t,selectors:[["career-page"]],decls:6,vars:1,consts:[["href","/contact"],[3,"timelineEvents"]],template:function(e,c){e&1&&(a(0,"h4"),r(1,"Feel free to "),a(2,"a",0),r(3,"contact me"),i(),r(4," if you'd like to get in touch!"),i(),s(5,"timeline",1)),e&2&&(o(5),l("timelineEvents",c.projectTimeline))},dependencies:[m],styles:["timeline[_ngcontent-%COMP%]{display:block;margin:20px 5%}h4[_ngcontent-%COMP%]{text-align:center}"]})};export{b as CareerPage};
