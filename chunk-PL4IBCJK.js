import{f as C}from"./chunk-XVNCFNIM.js";import"./chunk-QOKAHIDB.js";import{Ga as u,La as o,Y as g,Zb as v,_a as m,_b as b,ab as l,ac as x,fb as a,ga as p,gb as i,ha as f,hb as c,mb as w,ub as r,vb as h,xb as y}from"./chunk-EFDBRRIF.js";function I(e,d){e&1&&c(0,"div",8)}function _(e,d){if(e&1&&(a(0,"div",1)(1,"div",2)(2,"span"),r(3),i(),a(4,"div",3),c(5,"div",4),m(6,I,1,0,"div",5),i()(),a(7,"div",6)(8,"h1"),r(9),i(),c(10,"span",7),i()()),e&2){let n=d.$implicit,t=d.index,s=w();o(3),h(s.calculateTimelineDate(n.date)),o(3),l("ngIf",t!=s.timelineEvents.length-1),o(3),h(n.title),o(),l("innerHtml",n.content,u)}}var k=(()=>{class e{constructor(){this.timelineEvents=[]}calculateTimelineDate(n){return new Intl.DateTimeFormat("en-US",{year:"numeric",month:"long"}).format(n)}static{this.\u0275fac=function(t){return new(t||e)}}static{this.\u0275cmp=p({type:e,selectors:[["timeline"]],inputs:{timelineEvents:"timelineEvents"},decls:1,vars:1,consts:[["class","timeline-block",4,"ngFor","ngForOf"],[1,"timeline-block"],[1,"timeline-bar-container"],[1,"timeline-bar"],[1,"timeline-node"],["class","timeline-line",4,"ngIf"],[1,"timeline-content"],[3,"innerHtml"],[1,"timeline-line"]],template:function(t,s){t&1&&m(0,_,11,4,"div",0),t&2&&l("ngForOf",s.timelineEvents)},dependencies:[v,b],styles:[".timeline-block[_ngcontent-%COMP%], .timeline-bar-container[_ngcontent-%COMP%]{display:flex}.timeline-bar-container[_ngcontent-%COMP%]   span[_ngcontent-%COMP%]{min-width:80px;text-align:right;padding:6px 10px 0 0}.timeline-bar[_ngcontent-%COMP%]{display:inline-block}.timeline-node[_ngcontent-%COMP%]{border:3px solid grey}.timeline-line[_ngcontent-%COMP%]{border:2px solid grey;height:calc(100% - 33px);margin:auto;min-height:30px;width:0}.timeline-node[_ngcontent-%COMP%]{border-radius:18px;border-color:gray;height:25px;width:25px}.timeline-content[_ngcontent-%COMP%]{padding:0 20px 20px;flex-grow:1}.timeline-content[_ngcontent-%COMP%]   span[_ngcontent-%COMP%]{color:#d3d3d3}h1[_ngcontent-%COMP%]{margin-top:0}"]})}}return e})();var T=(()=>{class e{static{this.\u0275fac=function(t){return new(t||e)}}static{this.\u0275mod=f({type:e})}static{this.\u0275inj=g({imports:[x,C]})}}return e})();var F=(()=>{class e{constructor(){this.projectTimeline=[{date:new Date(16781652e5),title:"Senior Engineer",content:`<p>Still at Google, I was promoted to L5 for my contributions to the AV/VR efforts
        ...
        industry after schooling.`}]}static{this.\u0275fac=function(t){return new(t||e)}}static{this.\u0275cmp=p({type:e,selectors:[["career-page"]],standalone:!0,features:[y],decls:6,vars:1,consts:[["href","/contact"],[3,"timelineEvents"]],template:function(t,s){t&1&&(a(0,"h3"),r(1,"Feel free to "),a(2,"a",0),r(3,"contact me"),i(),r(4," if you'd like to get in touch!"),i(),c(5,"timeline",1)),t&2&&(o(5),l("timelineEvents",s.projectTimeline))},dependencies:[T,k],styles:["timeline[_ngcontent-%COMP%]{display:block;margin:20px 5%}h3[_ngcontent-%COMP%]{text-align:center}"]})}}return e})();export{F as CareerPage};
